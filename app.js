/* Modern Q&A App Styling - Premium Glassmorphism (YouTube Theme) */

:root {
  /* Default dark theme values (fallbacks for non-Telegram environments) */
  --bg-color: #0a0a0c;
  --secondary-bg-color: #16161a;
  ...
  --shadow-lg: 0 30px 60px rgba(0, 0, 0, 0.4), 0 0 40px rgba(255, 0, 0, 0.05);
  --transition-smooth: all 0.4s cubic-bezier(0.25, 1, 0.5, 1);
}

/* Override variables using Telegram Web App theme if available, but keep accent Red */
body.telegram-theme {
  --bg-color: var(--tg-theme-bg-color, #0a0a0c);
  --secondary-bg-color: var(--tg-theme-secondary-bg-color, #16161a);
  --text-color: var(--tg-theme-text-color, #ffffff);
  --text-secondary: var(--tg-theme-hint-color, #a1a1aa);
  /* Force YouTube Red for accents even in Telegram */
  --accent-color: #FF0000;
  --accent-hover: #CC0000; 
}
...
body {
  ...
  background: radial-gradient(circle at 50% 0%, rgba(255,0,0,0.05) 0%, var(--bg-color) 60%), var(--secondary-bg-color);
...
.card:hover {
  ...
  box-shadow: 0 35px 70px rgba(0, 0, 0, 0.5), 0 0 50px rgba(255, 0, 0, 0.08);
}
...
textarea:focus, input[type="text"]:focus {
  ...
  box-shadow: 0 0 0 3px rgba(255, 0, 0, 0.2), inset 0 2px 4px rgba(0,0,0,0.3);
}
